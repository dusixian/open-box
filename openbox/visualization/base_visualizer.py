...
def build_visualizer(option: Union[str, bool], optimizer, **kwargs):
    ...
    if option == 'none':
        ...
        visualizer = HTMLVisualizer(
            ...
            constraint_surrogate_type=advisor.constraint_surrogate_type if hasattr(advisor, 'constraint_surrogate_type') else None,
            config_space=advisor.config_space if hasattr(advisor, 'config_space') else None,
            rng=advisor.rng if hasattr(advisor, 'rng') else None,
            transfer_learning_history=advisor.transfer_learning_history if hasattr(advisor, 'transfer_learning_history') else None,
